...
, function(t, e) {
    L.Control.BrowserPrint = L.Control.extend({
        ...
        onAdd: function(t) {
            ...
            this.options.printModes.length > 1 ? (L.DomEvent.addListener(e, "mouseover", this._displayPageSizeButtons, this),
            L.DomEvent.addListener(e, "mouseout", this._hidePageSizeButtons, this)) : e.style.cursor = "pointer",
            this.options.position.indexOf("left") > 0 ? (this._createIcon(e),
            this._createMenu(e)) : (this._createMenu(e),
            this._createIcon(e)),
            t.printControl = this,
            e
        },
        ...
        _createMenu: function(t) {
            for (var e = [], r = 0; r < this.options.printModes.length; r++) {
                ...
                1 == this.options.printModes.length ? n.Element = t : (n.Element = L.DomUtil.create("li", "browser-print-mode", L.DomUtil.create("ul", "browser-print-holder", t)),
        ...
        _displayPageSizeButtons: function() {
            this.options.position.indexOf("left") > 0 ? (this.__link__.style.borderTopRightRadius = "0px",
            this.__link__.style.borderBottomRightRadius = "0px") : (this.__link__.style.borderTopLeftRadius = "0px",
        ...
        _hidePageSizeButtons: function() {
            this.options.position.indexOf("left") > 0 ? (this.__link__.style.borderTopRightRadius = "",
            this.__link__.style.borderBottomRightRadius = "") : (this.__link__.style.borderTopLeftRadius = "",
        ...
        _moveAutoPoligon: function(t) {
            this.options.custom && (t.originalEvent.preventDefault(),
            t.originalEvent.stopPropagation(),
            this.options.custom.rectangle ? this.options.custom.rectangle.setBounds(L.latLngBounds(this.options.custom.start, t.latlng)) : (this.options.custom.rectangle = L.rectangle([this.options.custom.start, t.latlng], this.options.customPrintStyle),
            this.options.custom.rectangle.addTo(this._map)))
        },
        _endAutoPoligon: function(t) {
            if (t.originalEvent.preventDefault(),
            t.originalEvent.stopPropagation(),
        ...
        _print: function(t, e) {
            ...
            if (o.printObjects = this._getPrintObjects(o.printLayer),
            ...
            this.cancelNextPrinting)
                ...
                t.InvalidateBounds ? (l.map.fitBounds(o.bounds),
                ...
                var p = setInterval((function() {
                    r._isTilesLoading(l.map) || (clearInterval(p),
                    r.options.manualMode ? r._setupManualPrintButton(l.map, o, l.objects) : r._completePrinting(l.map, o, l.objects))
                }
                ), 50)
            }
        },
        ...
        _addPrintCss: function(t, e, r) {
            ...
            switch (n.className = "leaflet-browser-print-css",
            n.setAttribute("type", "text/css"),
            n.innerHTML = " @media print { .leaflet-popup-content-wrapper, .leaflet-popup-tip { box-shadow: none; }",
            n.innerHTML += " .leaflet-browser-print--manualMode-button { display: none; }",
            n.innerHTML += " * { -webkit-print-color-adjust: exact!important; printer-colors: exact!important; color-adjust: exact!important; }",
        ...
        _appendControlStyles: function(t) {
            ...
            e.innerHTML += " .leaflet-control-browser-print { display: flex; } .leaflet-control-browser-print a { background: #fff url('data:image/png;base64,') no-repeat 5px; background-size: 16px 16px; display: block; border-radius: 2px; }",
            e.innerHTML += " .leaflet-control-browser-print a.leaflet-browser-print { background-position-x: 7px; }",
        ...
        _addPrintMapOverlay: function(t, e, r, n, i) {
            ...
            if (o.className = "grid-print-container",
            o.style.width = "100%",
            ...
            if (this.options.pagesSelector && document.querySelectorAll(this.options.pagesSelector).length) {
                ...
                this._setupPrintPagesWidth(o, r, n),
                ...
                n[a] = n[a].map((function(t) {
                    ...
                    if (e) {
                        ...
                        t instanceof L.Layer) {
                            var r = t.getTooltip();
                            r && (e.bindTooltip(r.getContent(), r.options),
        ...
        _getLoadingLayers: function(t) {
            for (var e in t._layers) {
                var r = t._layers[e];
                if ((r._url || r._mutant) && r._loading)
                    return !0
            }
            return !1
        }
...
, function(t, e) {
    L.Control.BrowserPrint.Utils = {
        ...
        initialize: function() {
            ...
            this.registerLayer(L.TileLayer.WMS, "L.TileLayer.WMS", (function(t, e) {
        ...
        cloneLayer: function(t) {
            ...
            return r || ((e = t._group ? this.__getFactoryObject(t._group, !0) : this.__getFactoryObject(t)) && (e = e.builder(t, this)),
            e)
        },
        getType: function(t) {
            if (!t)
...
, function(t, e) {
    ...
    L.Control.BrowserPrint.Mode = function(t, e, r, n, i) {
        ...
        this.PageSeries = -1 != ["A", "B", "C", "D"].indexOf(this.PageSize[0]) ? this.PageSize[0] : "",
        this.PageSeriesSize = this.PageSize.substring(this.PageSeries.length),
        this.Action = n || function(t, e) {
            return function() {
                t["_print" + e.Mode](e)
            }
        }
    ...
    L.Control.BrowserPrint.Mode.prototype.getPageMargin = function(t) {
        var e, r = this.getPaperSize(), n = (r.Width + r.Height) / 39.9;
        switch (t) {
        case "mm":
            e = n.toFixed(2) + "mm";
            break;
    ...
    L.Control.BrowserPrint.Mode.prototype.getPaperSize = function() {
        if (this.PageSeries) {
            var t = L.Control.BrowserPrint.Size[this.PageSeries]
              ...
              , r = t.Height
              , n = !1;
            return this.PageSeriesSize && (this.PageSeriesSize = +this.PageSeriesSize,
            (n = this.PageSeriesSize % 2 == 1) ? (e /= this.PageSeriesSize - 1 || 1,
            r /= this.PageSeriesSize + 1) : (e /= this.PageSeriesSize,
            r /= this.PageSeriesSize)),
            {
                Width: n ? r : e,
                Height: n ? e : r
            }
    ...
    L.Control.BrowserPrint.Mode.prototype.getSize = function() {
        ...
        return t.Width = Math.floor(t.Width - e) + "mm",
